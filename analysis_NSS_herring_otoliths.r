...
library(numDeriv)
# Read data
data_nss_otoliths = read.csv("SmartDots_Event_447_2022 NSS herring exchange (otoliths).csv", sep = ",")

# Only extract expert readers 
data_exp = data_nss_otoliths[data_nss_otoliths$expertise == 1, ]
...
print(xtable(mat), type = "latex", file = "M1_NSS_otolith.tex")
...
print(xtable(fitted_matrix), type = "latex", file = "M_full_NSS_otolith_2022.tex")
...
print(xtable(fitted_matrix_b), type = "latex", file = "M_best_NSS_otholitt_2022_modal_mean.tex")
