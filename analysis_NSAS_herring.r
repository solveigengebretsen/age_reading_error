...
# Read data
data_NSAS = read.csv("SmartDots_Event_534_IMR North Sea herring age reading (internal).csv", sep = ",")

# Only extract expert readers 
data_exp = data_NSAS[data_NSAS$expertise == 1, ]
...
print(xtable(mat), type = "latex", file = "M1_NSAS.tex")
